<?php 
   class Cliente {
       ...
       public function consulta() {
           $sql = "SELECT c.*, ci.nombre AS ciudad, ci.fo_dpto, d.nombre AS dpto
                   FROM cliente c
                   LEFT JOIN ciudad ci ON c.fo_ciudad = ci.id_ciudad
                   LEFT JOIN dpto d ON ci.fo_dpto = d.id_dpto
                   ORDER BY c.nombre";
        ...
        public function insertar($params) {
         ...
         public function filtro($dato) {
            $sql = "SELECT c.*,  ci.nombre AS ciudad, d.nombre AS dpto FROM cliente c
